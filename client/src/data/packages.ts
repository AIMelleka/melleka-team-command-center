...
export const MARKETING_PACKAGES: MarketingPackage[] = [
  ...
  },
  {
    ...
    tier: 4,
    monthlyPrice: 9499,
    description: 'Full-service marketing with AI CRM management and support for up to 3 franchise locations',
    ...
    highlights: ['Up to 3 Franchises', 'AI CRM Manager', '5 Hours Extra Tasks'],
  },
  ...
  // PREMIUM PLATINUM
  {
    ...
    tier: 5,
    monthlyPrice: 14999,
    description: 'The ultimate marketing solution with in-person content, TV ads, and support for up to 15 franchise locations',
