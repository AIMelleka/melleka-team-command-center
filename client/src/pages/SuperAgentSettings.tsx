...
const TOOL_CATEGORIES: ToolCategory[] = [
  ...
  {
    label: 'Social Media (Ayrshare)',
    icon: Share2,
    color: 'bg-sky-500/10 text-sky-600 dark:text-sky-400',
    tools: [
      { name: 'social_media (post)', description: 'Publish or schedule posts to 13+ platforms (Facebook, Instagram, X, LinkedIn, TikTok, etc.)' },
      { name: 'social_media (history)', description: 'View post history across all connected platforms' },
      { name: 'social_media (analytics)', description: 'Get post and profile analytics, follower counts, engagement metrics' },
      { name: 'social_media (comments)', description: 'Add, reply to, or delete comments on published posts' },
      { name: 'social_media (auto_schedule)', description: 'Set up automatic posting schedules by platform' },
      { name: 'social_media (generate)', description: 'AI-generate, rewrite, or translate social media posts' },
      { name: 'social_media (hashtags)', description: 'Get hashtag recommendations or auto-add relevant hashtags' },
      { name: 'social_media (media)', description: 'Upload images/videos and manage media gallery' },
      { name: 'social_media (messages)', description: 'Send and read direct messages across platforms' },
      { name: 'social_media (reviews)', description: 'Get and reply to reviews (Google Business Profile)' },
      { name: 'social_media (feeds)', description: 'Add RSS feeds for automated social posting' },
    ],
  },
  {
