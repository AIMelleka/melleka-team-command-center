...
- html: the exact HTML you built in Step 2 (all placeholders filled in)
- token: "daily-{yesterday YYYY-MM-DD}" (e.g. "daily-2026-07-14")
The tool returns a download URL.

STEP 4 — Add a download button to the email HTML, then send:
Insert this row immediately before the footer row (the row with "Generated by Melleka AI Strategist"):
<tr><td style="padding:16px 40px;text-align:center;border-top:1px solid #e8e0f5;"><a href="[URL from Step 3]" style="display:inline-block;background:#2d1b4e;color:#fff;text-decoration:none;padding:12px 28px;border-radius:6px;font-size:14px;font-weight:600;letter-spacing:0.3px;">&#x2193; Download PDF</a></td></tr>
